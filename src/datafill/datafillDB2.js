...
export default async function fillDataDB2(models) {
    ...
    const uniqueDB2Users = [
        { fullName: "DB2 User One", email: "db2_user1@example.com", city: "DB2City1" },
        { fullName: "DB2 User Two", email: "db2_user2@example.com", city: "DB2City2" },
        { fullName: "DB2 User Three", email: "db2_user3@example.com", city: "DB2City3" },
        { fullName: "DB2 User Four", email: "db2_user4@example.com", city: "DB2City4" },
        { fullName: "DB2 User Five", email: "db2_user5@example.com", city: "DB2City5" }
    ]
    ...
    console.log("Database 2 filled with sample data.");
}