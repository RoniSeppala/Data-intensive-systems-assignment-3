...
export async function fillDataDB3(models) {
    ...
    const uniqueDB3Content = [
        { title: "DB3 Regional Movie 1", contentType: "movie", genre: "Regional", year: 2022, durationMinutes: 102, ageRating: "12" },
        { title: "DB3 Regional Movie 2", contentType: "movie", genre: "Regional", year: 2023, durationMinutes: 108, ageRating: "16" },
        { title: "DB3 Regional Series 1", contentType: "series", genre: "Regional", year: 2024, durationMinutes: 42, ageRating: "12" },
        { title: "DB3 Regional Series 2", contentType: "series", genre: "Regional", year: 2025, durationMinutes: 48, ageRating: "16" },
        { title: "DB3 Regional Movie 3", contentType: "movie", genre: "Regional", year: 2026, durationMinutes: 93, ageRating: "7" }
    ];
